...
.. list-table::
   ...
   * - sriov-network-operator.images.ibSriovCni
     - string
     - `"nvcr.io/nvidia/mellanox/ib-sriov-cni:network-operator-v26.4.1"`
     -
   * - sriov-network-operator.images.operator
     - string
     - `"nvcr.io/nvidia/mellanox/sriov-network-operator:network-operator-v26.4.1"`
     -
   * - sriov-network-operator.images.ovsCni
     - string
     - `"nvcr.io/nvidia/mellanox/ovs-cni-plugin:network-operator-v26.4.1"`
     -
   * - sriov-network-operator.images.rdmaCni
     - string
     - `"nvcr.io/nvidia/mellanox/rdma-cni:network-operator-v26.4.1"`
     -
   ...
   * - sriov-network-operator.images.sriovCni
     - string
     - `"nvcr.io/nvidia/mellanox/sriov-cni:network-operator-v26.4.1"`
     -
   * - sriov-network-operator.images.sriovConfigDaemon
     - string
     - `"nvcr.io/nvidia/mellanox/sriov-network-operator-config-daemon:network-operator-v26.4.1"`
     -
   * - sriov-network-operator.images.sriovDevicePlugin
     - string
     - `"nvcr.io/nvidia/mellanox/sriov-network-device-plugin:network-operator-v26.4.1"`
     -
   * - sriov-network-operator.images.sriovDraDriver
     - string
     - `"nvcr.io/nvidia/mellanox/dra-driver-sriov:network-operator-v26.4.1"`
     -
   * - sriov-network-operator.images.webhook
     - string
     - `"nvcr.io/nvidia/mellanox/sriov-network-operator-webhook:network-operator-v26.4.1"`
     -
