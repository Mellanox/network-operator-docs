...
process-examples: | $(EXAMPLES_BUILD_DIR)
	...
	@find examples -name "*.yaml" -type f | while read -r file; do \
		echo "Processing $$file"; \
		relative_path=$$(echo "$$file" | sed 's|^examples/||'); \
